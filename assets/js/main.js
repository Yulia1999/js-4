 ...
 * #2
 *
 * Создайте функцию getLocalDate(date, isSeconds, isISO),
 *  которая будет принимать любую дату от конструктора new Date 
 * и преобразовывать ее в следующие форматы в зависимости от параметров:
...
//  let formatedDate = new Intl.DateTimeFormat('by-UA', {
// 	  year: 'numeric',
// 	   month: 'long',
// 	   day: 'numeric'
// 	 });
...
// //  * Объекты и их методы, созданные прототипом должны 
// полностью соответствовать объектам из прошлого задания.
// //  */
...
let car = new Car(2000, 'A6', 'Audi', 2021);
let car2 = new Car(5000, 'e100', 'Mersedes', 2010);
 ...
 *
 * Если в качестве параметра передается что-либо кроме функции,
 * тестирование не выполняется, возвращается 0.
 */
